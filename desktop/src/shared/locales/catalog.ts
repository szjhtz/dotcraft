...
const MESSAGES_EN = {
  ...
  'systemNotice.compacted.manual': 'Manual compaction complete',
  ...
  'composer.compact.started': 'Compacting current session context...',
  'composer.compact.succeeded': 'Session context compacted',
...
const MESSAGES_ZH: Record<MessageId, string> = {
  ...
  'systemNotice.compacted.manual': '手动压缩完成',
  ...
  'composer.compact.started': '正在压缩当前会话上下文...',
  'composer.compact.succeeded': '会话上下文已压缩',
